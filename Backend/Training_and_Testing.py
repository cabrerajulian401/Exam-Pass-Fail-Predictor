from Pre_Processing import Preprocessing_Data
...
with open("logistic_regression.pkl", "wb") as file:
    pickle.dump({"model":logreg_model, "preprocessor":process},file)

    print("Model and preprocessing pipeline saved as 'logistic_regression.pkl'")
